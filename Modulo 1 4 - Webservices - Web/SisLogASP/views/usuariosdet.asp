  ...
  <tr>
    <td scope="col"><table width="770" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr><td height="400" colspan="6" align="center" valign="top">
		...
		If msg = 1 then
			msg = "Alteração de senha não efetuada, senhas não estão iguais."
		end if
		
		SQL = "Select * from tblusuarios where usrIdUsuario = '"&cod&"'"
        ...
        <table width="600" border="1" cellpadding="0" cellspacing="0" class="sofT">
          <tbody>
            <tr>
              ...
              <td width="442">
              <input name="cod" type="hidden" value="2">
              <input name="usrIdUsuario" type="hidden" value="<%=rs("usrIdUsuario")%>">
              <input name="usrNomeUsuario" type="text" id="usrNomeUsuario" size="50" value="<%=rs("usrNomeUsuario")%>"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">CPF</td>
              <td><input name="usrCPF" type="text" id="usrCPF" value="<%=rs("usrCPF")%>" size="20" maxlength="11"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Email</td>
              <td><input name="usrEmail" type="text" id="usrEmail" size="20" value="<%=rs("usrEmail")%>"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Contato Fixo</td>
              <td><input name="usrContatoFixo" type="text" id="usrContatoFixo" value="<%=rs("usrContatoFixo")%>" size="20" maxlength="10"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Contato Celular</td>
              <td><input name="usrContatoCelular" type="text" id="usrContatoCelular" value="<%=rs("usrContatoCelular")%>" size="20" maxlength="11"></td>
            </tr>
            <tr>
              ...
              <select id="usrIdFuncao" name="usrIdFuncao">
                <%while NOT rs1.EOF%>
					<%if rs("usrIdFuncao") = rs1("fncIdFuncao") then%>
                        <option value="<%=rs1("fncIdFuncao")%>" selected="SELECTED"><%=rs1("fncDescicao")%></option>
                    <%else%>
            ...
            <tr>
              ...
              <select id="usrIdTransportadora" name="usrIdTransportadora">
                <%while NOT rs1.EOF%>
					<%if rs("usrIdTransportadora") = rs1("trptIdTransportadora") then%>
                        <option value="<%=rs1("trptIdTransportadora")%>" selected="SELECTED"><%=rs1("trptNome")%></option>
                    <%else%>
            ...
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Alterar Senha</td>
              <td class="txt_vermelho">
              <select id="alterarsenha" name="alterarsenha">
            ...
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Confirmação Senha</td>
              <td><input name="usrSenha02" type="password" id="usrSenha02" size="20" maxlength="6"></td>
            </tr>
            <tr>
