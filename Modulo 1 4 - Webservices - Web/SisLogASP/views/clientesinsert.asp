        ...
        <table width="600" border="1" cellpadding="0" cellspacing="0" class="sofT">
          <tbody>
            <tr>
              ...
              <td width="442"><input name="cod" type="hidden" value="1"><input name="cltNomeCliente" type="text" id="cltNomeCliente" size="50"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Endere&ccedil;o de Entrega</td>
              <td><input name="cltEnderecoEntrega" type="text" id="cltEnderecoEntrega" size="50"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">CEP</td>
              <td><input name="cltCEPEntrega" type="text" id="cltCEPEntrega" size="20"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Bairro</td>
              <td><input name="cltBairroEntrega" type="text" id="cltBairroEntrega" size="40"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Estado / Cidade</td>
              <td>
              <select id="cltUFEntrega" name="cltUFEntrega"></select>
              <select id="cltCidadeEntrega" name="cltCidadeEntrega"></select>
            ...
            <tr>
              ...
              <td><textarea name="cltObsEntrega" id="cltObsEntrega" cols="45" rows="5"></textarea></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table"><p>Email</p></td>
              <td><input name="cltEmail" type="text" id="cltEmail" size="30"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Contato Fixo</td>
              <td><input name="cltContatoFixo" type="text" id="cltContatoFixo" size="30"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Contato Celular</td>
              <td><input name="cltContatoCelular" type="text" id="cltContatoCelular" size="30"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Cliente Ativo</td>
              <td><select name="cltStatus" id="cltStatus">
