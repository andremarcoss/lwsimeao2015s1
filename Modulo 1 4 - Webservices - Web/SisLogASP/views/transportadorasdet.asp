  ...
  <tr>
    <td scope="col"><table width="770" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr><td height="400" colspan="6" align="center" valign="top">
		...
		SQL = "Select * from tbltransportadora where trptIdTransportadora = '"&cod&"'"
        ...
        <table width="600" border="1" cellpadding="0" cellspacing="0" class="sofT">
          <tbody>
            <tr>
              ...
              <input name="trptIdTransportadora" type="hidden" value="<%=rs("trptIdTransportadora")%>">
              <input name="trptNome" type="text" id="trptNome" size="50" value="<%=rs("trptNome")%>"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">CNPJ</td>
              <td><input name="trptCNPJ" type="text" id="trptCNPJ" value="<%=rs("trptCNPJ")%>" size="20" maxlength="14"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Endereço</td>
              <td><input name="trptEndereco" type="text" id="trptEndereco" size="50" value="<%=rs("trptEndereco")%>"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">CEP</td>
              <td><input name="trptCEP" type="text" id="trptCEP" value="<%=rs("trptCEP")%>" size="20" maxlength="8"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Bairro</td>
              <td><input name="trptBairro" type="text" id="trptBairro" size="30" value="<%=rs("trptBairro")%>"></td>
            </tr>
            <tr>
              <td bgcolor="#8EC8DE" class="txt_titulo_table">Estado / Cidade</td>
              <td>
              <%SQL1 = "Select * from tblEstados where estSigla = '"&rs("trptUF")&"'"
			  SET rs1 = Conexao.Execute(SQL1)
			  %>
              <select id="trptUF" name="trptUF" value="<%=rs("trptUF")%>"></select>
              <select id="trptCidade" name="trptCidade" value="<%=rs("trptCidade")%>"></select>
