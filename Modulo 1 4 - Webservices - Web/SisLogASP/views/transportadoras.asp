...
<%
	SQL = "Select * from tbltransportadora order by trptNome"
    ...
    <td scope="col"><table width="770" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr><td height="400" colspan="6" align="center" valign="top">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tbody>
            <tr>
              <td height="33" align="right"><a href="transportadorasinsert.asp"><img src="../img/incluir.jpg" width="75" height="26" alt=""/></a></td>
            </tr>
          </tbody>
        </table>
        <table width="369" border="1" cellpadding="0" cellspacing="0" class="sofT">
          <tbody>
          	<%if rs.EOF then%>
            <tr>
              <td colspan="2" class="txt_normal_bold">Não existem Transportadoras cadastrados.</td>
            </tr>
            <%else%>
            <tr class="txt_titulo_table">
              <td width="231" align="center" bgcolor="#8EC8DE">Transportadora</td>
              <td width="132" align="center" bgcolor="#8EC8DE">CNPJ</td>
              </tr>
            <%While not rs.EOF%>
            <tr class="txt_normal">
              <td><a href="transportadorasdet.asp?cod=<%=rs("trptIdTransportadora")%>"><%=rs("trptNome")%></a></td>
              <td><%=rs("trptCNPJ")%></td>
              </tr>
            <% rs.movenext
			Wend
